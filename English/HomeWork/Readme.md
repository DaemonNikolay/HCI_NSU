...
<td>Дискета называется так, потому что состоит из гибкого листа пластика, покрытого оксидом железа - намагничиваемого материала. Дисковод вращается со скоростью 360{three hundred sixty} оборотов в минуту (об/мин), поэтому он относительно медленный. Однако, вращение диска в 7200 оборотов в минуту и хранение данных в стеке металлических вращающихся дисков называемых пластинами жёсткого диска. Это значит, что Ыы можете хранить гораздо больше данных и извлекать информацию намного быстрее.</td>
</tr>
<tr>
